...
class MyColors {
  static const Color titleTextColor = Color(0xFFFF6F45);
  // static const Color titleTextColor = Color(0xFF504e9c);
  static const Color btnColor = Color(0xFFFF7F59);
  // static const Color btnColor = Color(0xFF4786ec);
  static const Color btnBorderColor = Color(0xffff5f30);
  // static const Color btnBorderColor = Color.fromARGB(255, 183, 181, 252);
  static const Color subTitleTextColor = Color(0xFFFF8F6E);
